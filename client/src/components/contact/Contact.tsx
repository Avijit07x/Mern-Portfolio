						...
						>
							<motion.div variants={fadeUp} className="w-full sm:w-auto">
								<motion.button
									...
									className="group relative inline-flex w-full items-center justify-center gap-2 overflow-hidden border border-white/10 bg-white/5 px-4 py-2 text-xs font-semibold tracking-[0.15em] text-white uppercase backdrop-blur-sm transition-all duration-500 hover:border-white/25 hover:bg-white/10 sm:w-auto"
								>
									<span className="relative z-10">Send a Message</span>
									<motion.div className="relative z-10 flex size-4.5 items-center justify-center overflow-hidden">
										<ArrowRight
											size={14}
