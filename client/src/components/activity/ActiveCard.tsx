		...
		>
			...
			<div className="relative z-10 size-28 shrink-0 drop-shadow-[0_0_20px_rgba(255,255,255,0.05)] md:size-32">
				...
				<motion.div
					...
					transition={{ duration: 0.7 }}
					className="absolute -right-3 -bottom-3 z-20 size-10 overflow-hidden rounded-xl border-4 border-[#020202] bg-[#020202] shadow-2xl"
				>
					<img
			...
			<div className="relative z-10 flex w-full flex-col space-y-4 text-left">
				<div className="relative space-y-1.5 pl-6 before:absolute before:inset-y-1 before:left-0 before:w-px before:bg-linear-to-b before:from-transparent before:via-white/20 before:to-transparent">
					...
					{activity.details && (
						<p className="text-sm font-medium tracking-tight text-white/80 md:text-base">
							{activity.details}
						</p>
					)}
					{activity.state && (
						<p className="text-xs leading-relaxed font-light tracking-wide text-white/40 md:text-sm">
							{activity.state}
						</p>
					)}
				</div>
